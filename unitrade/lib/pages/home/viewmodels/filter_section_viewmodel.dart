...
class FilterSectionViewModel extends ChangeNotifier {
  ...
  FilterSectionViewModel(FilterModel initialFilters) {
    minPriceController = TextEditingController(text: initialFilters.minPrice?.toString());
    maxPriceController = TextEditingController(text: initialFilters.maxPrice?.toString());
    minRateController = TextEditingController(text: initialFilters.minRate?.toString());
    maxRateController = TextEditingController(text: initialFilters.maxRate?.toString());
  }
