...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final connectivityBannerService =
        Provider.of<ConnectivityBannerService>(context, listen: false);

    // Enable monitoring after entering the view
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // connectivityBannerService.enableMonitoring();
